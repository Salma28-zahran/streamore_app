...
class VerifyPass1 extends StatefulWidget {
  static const String routeName = "/verifypass1";

  const VerifyPass1({super.key});

  @override
  State<VerifyPass1> createState() => _VerifyEmail1State();
}

class _VerifyEmail1State extends State<VerifyPass1> {
